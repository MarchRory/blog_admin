...
<template>
  <div class="p-4 h-1/1 w-1/1 flex md:flex enter-y flex-col justify-between">
    <div class="w-1/1 h-3/10 flex items-center justify-center">
      <div class="h-33 w-33 rounded-full overflow-hidden">
        <img
          class="object-cover h-33 w-33"
          src="https://profile-avatar.csdnimg.cn/50fe2c116cdf4e0c90464a2474940eba_liushi21.jpg"
          alt=""
        />
      </div>
    </div>
