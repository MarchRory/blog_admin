<script setup lang="ts">
  ...
  const tagColumns: TableColumnsType = [
    { title: 'LOGO', width: 30, dataIndex: 'tagIcon', key: 'tagIcon' },
  ...
  onMounted(() => {
    tagTableHeight.value = Math.floor((tagTableContainer.value!.offsetHeight / 15) * 13)
