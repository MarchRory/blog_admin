...
<template>
  <div class="p-4 h-1/1 flex md:flex enter-y flex-col justify-between">
    ...
    <a-modal
      ...
      :ok-button-props="{ disabled: !allowSubmit }"
      ...
      <div>
        ...
        >
          <a-form-item name="tagname" label="专栏名称" v-bind="formState.tagname">
            <a-input v-model:value="formState.tagname" size="small" placeholder="请输入专栏名" />
          </a-form-item>
          <a-form-item name="tagIcon" label="专栏logo" v-bind="formState.tagIcon">
            <Icon-picker :value="chosenIcon" width="60%" :page-size="20" mode="svg"></Icon-picker>
          </a-form-item>
        </a-form>
      </div>
    </a-modal>
