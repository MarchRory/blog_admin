<script setup lang="ts">
  ...
  import { log } from 'console';
    ...
    const tableColumns: TableColumnsType = [
      ...
      { title: 'LOGO', width: 60, dataIndex: 'tagIcon', key: '_id' },
      { title: '专栏名', width: 150, dataIndex: 'tagname', key: 'tagIcon' },
      { title: '文章数量', width: 80, dataIndex: 'hasNums', key: '_id' },
