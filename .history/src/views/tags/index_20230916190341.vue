<script setup lang="ts">
  ...
  import { a-table } from 'ant-design-vue'
  import { ref } from 'vue'
  interface dataItem {
    tagname: Stirng
    tagIcon: String
  ...
  const tableColumns: TableColumnsType = [
    ...
    { title: '操作', width: 150, key: 'operation', fixed: 'right' },
  ]
...
<template>
  <div class="p-4 h-1/1 flex md:flex enter-y flex-col justify-between">
    ...
    <div class="bar h-13/15 flex flex justify-between" style="background-color: white">
      ...
      <a-table :columns="tableColumns" :data-source="tagList" :scroll="{ x: 1500, y: 300 }">
