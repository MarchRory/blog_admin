<script setup lang="ts">
  ...
  const edit = (record) => {
    ...
    formState.value.avatar = copy.avatar
  ...
  <div class="p-4 h-1/1 flex md:flex enter-y flex-col justify-between">
      ...
      >
        <template #bodyCell="{ column, record }">
          ...
          <template v-else-if="column.key === 'avatar'">
            <span>
              <Icon :icon="record.avatar" :size="25"></Icon>
            </span>
          </template>
        </template>
      </a-table>
    ...
    >
      <div class="p-6">
        ...
        >
          <a-form-item name="nickname" label="头像">
            <a-input
              type="text"
          ...
          <a-form-item name="homePath" label="博客主页地址">
            <a-input
              type="text"
          ...
          <a-form-item name="homePath" label="友链简介">
            <a-textarea v-model:value="formState.introduce" show-count :maxlength="100" />
            <a-input
              type="text"
