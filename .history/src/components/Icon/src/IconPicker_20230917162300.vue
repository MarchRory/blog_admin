            ...
            <ScrollContainer class="border border-solid border-t-0">
              <ul class="flex flex-wrap px-2">
                <li
                  ...
                  class="p-2 w-max cursor-pointer mr-1 mt-1 flex justify-center items-center border border-solid hover:border-primary"
                  @click="handleClick(icon)"
                  :title="icon"
                >
                  <!-- <Icon :icon="icon" :prefix="prefix" /> -->
                  <SvgIcon v-if="isSvgMode" :name="icon" :size="size" />
                  <Icon :icon="icon" :size="size" v-else />
                </li>
              </ul>
            </ScrollContainer>
...
<script lang="ts" setup>
  ...
  import iconsData from '../data/skillIcons.data'
