...
export async function updateTag(data: updateTagModel, mode: ErrorMessageMode = 'modal') {
...
export async function deleteTag(tagId: delTagModel, mode: ErrorMessageMode = 'modal') {
  return await defHttp.put(
    {
      url: API.updateTag + '/' + tagId,
    },
    {
      errorMessageMode: mode,
    },
